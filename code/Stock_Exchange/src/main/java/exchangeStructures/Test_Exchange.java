...
public class Test_Exchange extends junit.framework.TestCase {
	...
	public void test1() throws Exception {
		...
		market.setOfferBook(offerBook);
		BidBook bidBook = new BidBook();
		market.setBidBook(bidBook);
		...
		Side side0 = Side.BUY; // 
		Quantity quantity0 = new Quantity(1000L); // long
		...
		// Make sure that the above sweeping order generated a resting order
				...
				assertTrue( 
					exchange
						.getMarket( marketId0 ) //market
						.getBidBook() // bidBook
						.getPriceLevels() // list of price levels
						.get( priceOfPriceLevel ) // get  ......
						.getOrders()
						.get( orderIndex )
